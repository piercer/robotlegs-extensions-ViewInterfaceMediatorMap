...
package org.robotlegs.mvcs
{
	...
	import org.robotlegs.mvcs.support.TestViewInterfaceMappingContext;
	import org.robotlegs.mvcs.support.TestContextView;

	public class ViewInterfaceMappingContextTests
	{
		private var context:TestViewInterfaceMappingContext;
		...
		{
			context = new TestViewInterfaceMappingContext(contextView, true);
		...
		{
			context = new TestViewInterfaceMappingContext(null, true);
		...
		{
			context = new TestViewInterfaceMappingContext(contextView, false);
			Assert.assertFalse("Context should NOT have started", context.startupComplete);
			context.startup();
		...
		{
			context = new TestViewInterfaceMappingContext(null, false);
			Assert.assertFalse("Context should NOT have started", context.startupComplete);
			context.contextView = contextView;
			context.startup();
			Assert.assertTrue("Context should now be started", context.startupComplete);
		...
		{
			context = new TestViewInterfaceMappingContext(contextView);
