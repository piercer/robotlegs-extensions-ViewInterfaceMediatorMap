package org.robotlegs.base
{
    ...
    import org.robotlegs.mvcs.support.ViewInterfaceMediator;
    import org.robotlegs.mvcs.support.ViewMediator;
	import org.robotlegs.mvcs.support.ViewMediatorAdvanced;

	public class InterfaceEnabledMediatorMapTests
	{
        ...
        [Test]
        public function mediatorIsMappedAndCreatedForViewInterface():void
        {
            mediatorMap.mapView(IViewComponent, ViewInterfaceMediator);
            var viewComponent:ViewComponent = new ViewComponent();
            contextView.addChild(viewComponent);
            var mediator:IMediator = mediatorMap.createMediator(viewComponent);
            Assert.assertNotNull('Mediator should have been created ', mediator);
        ...
        [Test]
        public function interfaceMediatorIsMappedAddedAndRemoved():void
        {
            var viewComponent:ViewComponent = new ViewComponent();
            var mediator:IMediator;

            mediatorMap.mapView(IViewComponent, ViewInterfaceMediator, null, false, false);
            contextView.addChild(viewComponent);
            mediator = mediatorMap.createMediator(viewComponent);
            Assert.assertNotNull('Mediator should have been created', mediator);
            Assert.assertTrue('Mediator should have been created', mediatorMap.hasMediator(mediator));
        ...
        [Test]
        public function interfaceMediatorIsMappedAddedAndRemovedByView():void
        {
            var viewComponent:ViewComponent = new ViewComponent();
            var mediator:IMediator;
        ...
        [Test]
        public function autoRegisterWithInterface():void
        {
            mediatorMap.mapView(IViewComponent, ViewInterfaceMediator, null, true, true);
            var viewComponent:ViewComponent = new ViewComponent();
            contextView.addChild(viewComponent);
            Assert.assertTrue('Mediator should have been created for View Component', mediatorMap.hasMediatorForView(viewComponent));
        }
        ...
        [Test(async, timeout='500')]
        public function interfaceMediatorIsRemovedWithView():void
        {
            var viewComponent:ViewComponent = new ViewComponent();
            var mediator:IMediator;

            mediatorMap.mapView(IViewComponent, ViewInterfaceMediator, null, false, true);
            contextView.addChild(viewComponent);
            mediator = mediatorMap.createMediator(viewComponent);
            Assert.assertNotNull('Mediator should have been created', mediator);
            Assert.assertTrue('Mediator should have been created', mediatorMap.hasMediator(mediator));
        ...
        [Test]
        public function unmapViewInterface():void
        {
            mediatorMap.mapView(IViewComponent, ViewInterfaceMediator);
            mediatorMap.unmapView(IViewComponent);
            var viewComponent:ViewComponent = new ViewComponent();
            contextView.addChild(viewComponent);
            var hasMediator:Boolean = mediatorMap.hasMediatorForView(viewComponent);
            Assert.assertFalse('Mediator should NOT have been created for View Component', hasMediator);
        ...
        [Test]
		public function autoRegisterUnregisterRegisterWithInterfaces():void
		{
			var viewComponent:ViewComponent = new ViewComponent();
